        ...
        <div class="col-md-4">
            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" CssClass="form-control" CausesValidation="True"/>
                </div>
                <div class="form-group">
                    <label for="txtConfirmPasswordd">Confirm Password</label>
                    <asp:TextBox ID="txtConfirmPassword" runat="server" TextMode="Password" CssClass="form-control" CausesValidation="True" />
                </div>
                <div class="form-group">
